...
//require_once(dirname(__FILE__)."/DependencySet.php");
...
$e = new DependencySet("Field1","Field2");

print $t->ok(is_object($e),false);



$test = $e->getRequiredField();
print $t->ok($test == "Field2","1",$test);

$test = $e->getUsedField();
print $t->ok($test == "Field1","1",$test);
