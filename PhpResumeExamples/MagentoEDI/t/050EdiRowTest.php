...
$e = new Dhtechnologies_Ediconnectorbase_Model_Connector_Edi_Core_Documents_Type_EdiRow();
...
print $t->ok($e->getValue("TEST") == "999","1",$e->getValue("TEST"));
print $t->ok($e->getValue("TEST9") == null,"2",$e->getValue("TEST9"));
